...
export default function (props) {
  return (
    ...
    <div>
      <h1>Hello world</h1>
      <p>Hello world - это веб-приложение на базе <a href="http://www.oknosoft.ru/metadata/" target="_blank">Metadata.js</a> для демонстрации базовых возможностей фреймворка</p>
