  ...
  return (
    ...
    <div>
      ...
      <p>Hello world - это веб-приложение на базе <a href="http://www.oknosoft.ru/metadata/"
                                                     target="_blank">Metadata.js</a> для демонстрации базовых возможностей фреймворка</p>
      ...
      <ul>
        ...
        <li><a href="https://github.com/adazzle/react-data-grid" target="_blank">React data grid</a>, React компонент табличной части</li>
      ...
      </a> или <a href="http://www.oknosoft.ru/metadata/#page-118" target="_blank">свяжитесь с разработчиком</a> напрямую</p>
    </div>
  )
}
